                    ...
                    <div class="grid-12">
                        ...
                        <div id="main" class="clearfix">
                            ...
                            <?php if ($page['sidebar_first_wide']): ?>
                                <aside id="sidebar-first-wide" class="column column_left grid-5 alpha" role="complementary">
                                    <div class="section">
            ...
            <div class="container-12">
                <div class="grid-12">
                    <div class="footer-wrapper clearfix">
                        ...
                        <?php if ($is_front): ?>More <a rel="nofollow" href="http://www.templatemonster.com/category.php?category=0&type=26" target="_blank"> at TemplateMonster.com</a><?php endif; ?>
                    </div>
                </div>
            </div>
        </footer>
